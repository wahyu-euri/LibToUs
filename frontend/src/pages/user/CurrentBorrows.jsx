                  ...
                  <div key={borrow.id} className="borrow-card">
                    <div className="book-info">
                      ...
                      <div className="book-details">
                        ...
                        <p className="book-author">by {borrow.book?.author}</p>
                        ...
                        {isOverdue && (
                          <div className="overdue-warning">
                            <strong>Overdue by {Math.abs(daysRemaining)} days</strong>
                            <span>Please return this book as soon as possible.</span>
                          </div>
                        )}
                        {!isOverdue && (
